...
class _ChatService implements ChatService {
  ...
  @override
  Future<SessionResponse> startSession({required UserBody body}) async {
  ...
  @override
  Future<void> endSession({required UserBody body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<Message> message({required MessageBody body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
